    ...
    <AuthProvider>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/principal" element={<ProtectedRoute papelPermitido="admin"><Principal /></ProtectedRoute>} />
          <Route path="/perfil" element={<ProtectedRoute><Perfil /></ProtectedRoute>} />
          <Route
            path="/dashboard"
            element={<ProtectedRoute papelPermitido="admin"><Dashboard /></ProtectedRoute>}
          />
          <Route
            path="/pacientes"
